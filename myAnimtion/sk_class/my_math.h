...
public:
    ...
    glm::mat4 toMat4(){
        ...
        mat[1][0]=m[1][0];  mat[1][1]=m[2][1];  mat[1][2]=m[1][2]; mat[1][3]=m[1][3];
        mat[2][0]=m[2][0];  mat[2][1]=m[3][1];  mat[2][2]=m[2][2]; mat[2][3]=m[2][3];
        mat[3][0]=m[3][0];  mat[3][1]=m[4][1];  mat[3][2]=m[3][2]; mat[3][3]=m[3][3];
        return mat;
    }
