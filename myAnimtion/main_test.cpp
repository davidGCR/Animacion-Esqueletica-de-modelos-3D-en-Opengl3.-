...
int main( void )
{
	...
	//SINO con OBJ	
	Object3D* body = new Object3D("data/batma.obj",true);
	// Object3D* body = new Object3D("data/res/models/nanosuit.obj",true);
	// Object3D* body = new Object3D("data/models/ArmatureStraight.dae");


	body->setShaders("StandardShading.vertexshader.glsl", "phong.fragmentshader.glsl");
	...
	GLuint Texture= loadDDS("data/cube/uvmap.DDS");
	GLuint TextureID  = glGetUniformLocation(gizmo->programID, "myTextureSampler");
