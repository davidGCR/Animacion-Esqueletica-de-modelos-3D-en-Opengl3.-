...

{
    ...
    fclose(file);
    cout<<"OBJ: n_vertices: "<<out_vertices.size()<<endl;
//    cout<<"OBJ: indices: "<<indices.size()<<endl;
//    cout<<"OBJ: faces: "<<mesh->mNumFaces<<endl;
    return true;
}
// // Include AssImp
...
bool loadAssImp( const char * path, std::vector<unsigned int> & indices, std::vector<glm::vec3> & vertices,
...
//    cout<<"OBJ: n_vertices: "<<vertices.size()<<endl;
//    cout<<"OBJ: indices: "<<indices.size()<<endl;
//    cout<<"OBJ: faces: "<<mesh->mNumFaces<<endl;
...
//     for(int meshId = 1;meshId < vmesh.size();meshId++){
